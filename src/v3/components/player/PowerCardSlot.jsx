...
export default function PowerCardSlot({ cardId, slotIndex, isEmpty }) {
  ...
  return (
    <motion.div
      ...
      transition={{ type: 'spring', stiffness: 250, damping: 20, delay: slotIndex * 0.1 }}
    ...
    >
      ...
      {/* Hover tooltip — full card detail */}
      <AnimatePresence>
        {hovered && (
          <motion.div
