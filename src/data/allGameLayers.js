...
export const allGameLayers = {
    red: {
        ...
        actions: [
            ...
            { id: 'redHybrid1', title: '+1 🔴 + Swap Patrons', description: '(Swap one of your other patrons with another player\'s. Both execute their new action)', round: 1 },
            ...
            { id: 'redHybrid2', title: '+1 🔴 + Swap Patrons', description: '(Swap one of your other patrons with another player\'s. Only you execute your new action)', round: 2 },
